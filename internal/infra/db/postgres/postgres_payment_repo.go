// File: internal/infra/db/postgres/postgres_payment_repo.go
package postgres
...
func (r *PostgresPaymentRepo) FindByID(ctx context.Context, qx any, id string) (*model.Payment, error) {
	const q = `
SELECT id, user_id, plan_id, provider, amount, currency, authority, ref_id, status, created_at, updated_at, paid_at, callback, description, meta, subscription_id, activation_code, activation_expires_at
...
func (r *PostgresPaymentRepo) FindByAuthority(ctx context.Context, qx any, authority string) (*model.Payment, error) {
	const q = `
SELECT id, user_id, plan_id, provider, amount, currency, authority, ref_id, status, created_at, updated_at, paid_at, callback, description, meta, subscription_id, activation_code, activation_expires_at
  FROM payments WHERE authority=$1 LIMIT 1;`
...
func (r *PostgresPaymentRepo) UpdateStatus(ctx context.Context, qx any, id string, status string, refID *string, paidAt *time.Time) error {
...
func (r *PostgresPaymentRepo) FindByActivationCode(ctx context.Context, qx any, code string) (*model.Payment, error) {
	const q = `
SELECT id, user_id, plan_id, provider, amount, currency, authority, ref_id, status, created_at, updated_at, paid_at, callback, description, meta, subscription_id, activation_code, activation_expires_at
  FROM payments WHERE activation_code=$1 LIMIT 1;`
